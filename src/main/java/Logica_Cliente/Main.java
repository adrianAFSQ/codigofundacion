...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (conteo != 0) {
            System.out.println("Digite la serial de la computador");
            serial = scan.nextLine();
            conteo = HelperValidacion.ValidarTodoSerial(serial);
        ...
        while (rta > 0) {
            System.out.println("Digite la tamaño del computador");
            tamaño = scan.nextLine();
            rta = HelperValidacion.ValidarVacio(tamaño);
        }
        ...
        while (conteo != 0) {
            System.out.println("Digite la tamaño de la computador");
            tamaño = scan.nextLine();
            conteo = HelperValidacion.ValidarTodo(tamaño);
        ...
        while (conteo != 0) {
            System.out.println("Digite la color de la computador");
            color = scan.nextLine();
            conteo = HelperValidacion.ValidarTodo(color);
        ...
        while (rta > 0) {
            System.out.println("Digite el cedula de la persona");
            cedula = scan.nextLine();
            rta = HelperValidacion.ValidarVacio(cedula);
        }
